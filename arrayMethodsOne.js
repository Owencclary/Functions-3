...
// CODE HERE
const postTaxPrices = prices.map(function(element) { return element * 1.07 });
...
// CODE HERE
const totalPopulation = populations.reduce(function(total, element) { return total + element } )
...
// CODE HERE
const orderTotals = order.map(function(element) { 
  return element.price * (element.tax * 100)
})
...
// CODE HERE
const bobsTotal = purchases.filter(function(total, element) { 
