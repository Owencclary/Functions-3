...
// CODE HERE
const newArray = numbers.map(function(element) { return element / 2 } )
...
// CODE HERE
const citiesi = cities.filter(function(element) { 
...
/* 
    Using forEach method, identify each element of the 'fruits' array above if it's an apple or orange by its color. If the color is red,
     print "The fruit with index [THE ELEMENT'S INDEX] is an apple."
      If the color is orange, print "The fruit with index [THE ELEMENT INDEX] 
     is an orange." If the color is not red or apple, print "The fruit with index [THE ELEMENT'S INDEX] is neither apple or orange."
...
// CODE HERE
const totalPriceOfRice = foods.filter(function(element) {
